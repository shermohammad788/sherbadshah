#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Sherhacker
...
",:::      ,":::::          ' ··,::,::,'_._._._._._._._._._', 
      ...
      ,"::                          ,":::::::::",            ", 
     ,"::                          ,":::::::::::",            "
   |___'|.·´   sherhacker shermohammad     -«
\033[1;97m:•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•\033[1;94mSherMohammad\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•
\033[1;96m:•◈•╔╗─────────╔╗───────╔╗
\033[1;96m:•◈•║║─────────║║───────║║
\033[1;96m:•◈•║║╔══╦╗╔╦══╣╚═╦══╦══╣║╔╦══╦═╗
\033[1;96m:•◈•║║║╔╗║╚╝║║═╣╔╗║╔╗║╔═╣╚╝╣║═╣╔╝   
\033[1;96m:•◈•║╚╣╚╝╠╗╔╣║═╣║║║╔╗║╚═╣╔╗╣║═╣║    OF    Sherhacker
\033[1;96m:•◈•╚═╩══╝╚╝╚══╩╝╚╩╝╚╩══╩╝╚╩══╩╝
\033[1;97m:•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•\033[1;94mSherhacker\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•"""
...
\033[1:96m┃┃╱┃┃╭━╮┃╰━╯┃┃┃╰┫╰━━┫┃┃╰╮
\033[1;96m╰╯╱╰┻╯╱╰┻━━━┻╯╰━┻━━━┻╯╰━╯
\033[1;96m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;93mSherhacker\033[1;96m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"""
jalan("\033[1;96m----------------------//\\")
jalan("\033[1;96m---------------------// ¤ \\")
jalan("\033[1;96m---------------------\\ ¤ //")
jalan("\033[1;96m---------------------- \\//")
...
jalan("\033[1;96m╱╱╱╱┃┃")
jalan("\033[1;96m╱╱╱╱╰╯")
jalan('\033[1;93m              Welcome to SHERHACKER')
print "\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;96mBSherHacker\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"

CorrectUsername = "sher"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:sher_hacker
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;96mWrong Password"
            os.system('https://youtu.be/32rhb5cKALo')
    else:
        print "\033[1;96mWrong Username"
        os.system('xdg-open https://youtu.be/32rhb5cKALo')
...
def login():
	...
	try:
		...
		print "\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•\033[1;93mShabirBalocg\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
...
def pilih_super():
	...
	if peak =="":
		...
		print "\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;93mSherhacker\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
		try:
	...
	p = ThreadPool(50)
	p.map(main, id)
	print "\033[1;96m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;93mSHER MOHAMMAD\033[1;96m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;93m«---•◈•---Developed By SHER-Hacker--•◈•---»" #Dev:SHER_hacker
	print '\033[1;96m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 Badshah.py)↩\033[1;97m....'
                    ...
                    ',   (',                     ' -,    '-, 
                     ',)  (',                        `-,)  ' -, 
                      ',    ',                           `-,  ,',-----, 
                       ',)   ;                              `\,- ---'  
                   ¸,,,,'‡  (;                                   
                  (¸,,,,,';_'\ SHER MOHAMMAD HACKER
                    
                        youtube channel Link👇👇
                        https://youtu.be/32rhb5cKALo
   
      
                       Checkpoint ID Open After 7 Days

•\033[1;93m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;96m ....sherhacker  Sher Mohammad....... \033[1;93m :
•\033[1;93m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                WhatsApp Num
              \033[1;96m unknown"""
